...
const (
	// MaxStackDepth is the maximum runtime.memProfile stack captured by BPF.
	MaxStackDepth         = 64
	firstSupportedGoMinor = 21
	lastSupportedGoMinor  = 24
)

// RuntimeLayout describes the Go runtime heap-profile structures read by BPF.
