...
|loadavg_container_load5|容器 5 分钟 R+D 平均负载估算|计数|容器| host, region |cgroup v1/v2，可配置 EMA 采样间隔，默认 15 秒|
|loadavg_container_load15|容器 15 分钟 R+D 平均负载估算|计数|容器| host, region |cgroup v1/v2，可配置 EMA 采样间隔，默认 15 秒|
